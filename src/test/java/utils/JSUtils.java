...
import static utils.BrowserUtils.waitForVisibility;

public class JSUtils{

    public static void clickElementByJS(WebElement element) {
        JavascriptExecutor jsexecutor = ((JavascriptExecutor) DriverMngr.getDriver());
        waitForVisibility(element);
        jsexecutor.executeScript("arguments[0].click();", element);
    }
    public static void jsScrollClick(WebElement webElement) {  //kaydir ve tikla
        JavascriptExecutor js = (JavascriptExecutor) DriverMngr.getDriver();
        try {
            webElement.click();
        } catch (Exception e) {
...
//    JSUtils.scrollIntoViewJS(driver.findElement(By.id("submit-button")));
    ...
    public static void changeColor(String color, WebElement element) {
        JavascriptExecutor javascriptExecutor = ((JavascriptExecutor) DriverMngr.getDriver());
    ...
    public static void executeJScommand(WebElement element, String command) {
        JavascriptExecutor jse = (JavascriptExecutor) DriverMngr.getDriver();
